...
Змінив кількість реплік для додатку на 5 та передеплоїв. Як видно на скрині, пілся передеплою, створилось теперь 5 подів. Також kubectl rollout status показав, що деплоймент пройшов успішно.
