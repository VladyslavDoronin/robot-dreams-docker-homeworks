...
Помилки більше не трапляютьтся. 

Також використав depends_on: - redis, щоб мій контейнер запускався після того як redis запуститься і буде готовий приймати запити. Щоб не працював в холосту і не вилітав

Ось логи мого контейнера і на початку видно послідовність запущених контейнерів
