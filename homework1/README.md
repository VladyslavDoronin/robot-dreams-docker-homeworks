...
4. Відкрити в браузері http://localhost:8080 (або http://127.0.0.1:8080) та впевнитись, що контейнер працює
...
5. Запустити 10 контейнерів з образом `nginx`. Можна спробувати по одному, або автоматизувати
...
6. Зупинити всі запущені контейнери та видалити їх. Раджу спробувати знайти спосіб зробити це однією командою
