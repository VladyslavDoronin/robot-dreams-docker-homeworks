...
3. Відкрити в браузері http://localhost:8080 (або http://127.0.0.1:8080) та впевнитись, що контейнер працює
   Контейнер hello-world не має веб сервера, тому нічого не відкриється. Цей контейнер виводить лише привітання і одразу зупиняється що можно побачити на скрині вище. Для того щоб відкрити в браузері і щось побачити, можно використати nginx контейнер.
